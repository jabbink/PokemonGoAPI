...
public class PokemonMetaRegistry {
    ...
    static {
        ...
        metap.setPokemonClass(PokemonMeta.PokemonClass.COMMON);
        metap.setType2(PokemonMeta.PokemonType.POISON);
        ...
        metap.setMovementType(PokemonMeta.MovementType.JUMP);
        metap.setType1(PokemonMeta.PokemonType.GRASS);
        ...
        metap.setFamily(PokemonFamilyId.FAMILY_BULBASAUR);
        metap.setPokemonClass(PokemonMeta.PokemonClass.RARE);
        metap.setType2(PokemonMeta.PokemonType.POISON);
        ...
        metap.setFamily(PokemonFamilyId.FAMILY_BULBASAUR);
        metap.setPokemonClass(PokemonMeta.PokemonClass.EPIC);
        metap.setType2(PokemonMeta.PokemonType.POISON);
        ...
        metap.setPokemonClass(PokemonMeta.PokemonClass.COMMON);
        metap.setType2(PokemonMeta.PokemonType.NONE);
        ...
        metap.setMovementType(PokemonMeta.MovementType.JUMP);
        metap.setType1(PokemonMeta.PokemonType.FIRE);
        ...
        metap.setFamily(PokemonFamilyId.FAMILY_CHARMANDER);
        metap.setPokemonClass(PokemonMeta.PokemonClass.EPIC);
        metap.setType2(PokemonMeta.PokemonType.FLYING);
        ...
        metap.setMovementType(PokemonMeta.MovementType.FLYING);
        metap.setType1(PokemonMeta.PokemonType.FIRE);
        ...
        metap.setMovementType(PokemonMeta.MovementType.JUMP);
        metap.setType1(PokemonMeta.PokemonType.WATER);
        ...
        metap.setPokemonClass(PokemonMeta.PokemonClass.VERY_COMMON);
        metap.setType2(PokemonMeta.PokemonType.NONE);
        ...
        metap.setMovementType(PokemonMeta.MovementType.JUMP);
        metap.setType1(PokemonMeta.PokemonType.BUG);
        ...
        metap.setFamily(PokemonFamilyId.FAMILY_CATERPIE);
        metap.setPokemonClass(PokemonMeta.PokemonClass.UNCOMMON);
        metap.setType2(PokemonMeta.PokemonType.FLYING);
        metap.setPokedexHeightM(1.1);
        metap.setHeightStdDev(0.1375);
        metap.setBaseStamina(120);
        ...
        metap.setMovementType(PokemonMeta.MovementType.ELECTRIC);
        metap.setType1(PokemonMeta.PokemonType.BUG);
        ...
        metap.setMovementType(PokemonMeta.MovementType.JUMP);
        metap.setType1(PokemonMeta.PokemonType.NORMAL);
        ...
        metap.setPokedexWeightKg(6.9);
        metap.setMovementType(PokemonMeta.MovementType.JUMP);
        metap.setType1(PokemonMeta.PokemonType.POISON);
        ...
        metap.setMovementType(PokemonMeta.MovementType.NORMAL);
        metap.setType1(PokemonMeta.PokemonType.ELECTRIC);
        ...
        metap.setFamily(PokemonFamilyId.FAMILY_PIKACHU);
        metap.setPokemonClass(PokemonMeta.PokemonClass.VERY_RARE);
        metap.setType2(PokemonMeta.PokemonType.NONE);
        ...
        metap.setMovementType(PokemonMeta.MovementType.JUMP);
        metap.setType1(PokemonMeta.PokemonType.GROUND);
        ...
        metap.setFamily(PokemonFamilyId.FAMILY_NIDORAN_FEMALE);
        metap.setPokemonClass(PokemonMeta.PokemonClass.VERY_RARE);
        metap.setType2(PokemonMeta.PokemonType.GROUND);
        ...
        metap.setMovementType(PokemonMeta.MovementType.NORMAL);
        metap.setType1(PokemonMeta.PokemonType.FAIRY);
        ...
        metap.setPokemonClass(PokemonMeta.PokemonClass.COMMON);
        metap.setType2(PokemonMeta.PokemonType.FAIRY);
        metap.setPokedexHeightM(0.5);
        metap.setHeightStdDev(0.0625);
        ...
        metap.setPokemonClass(PokemonMeta.PokemonClass.VERY_COMMON);
        metap.setType2(PokemonMeta.PokemonType.GRASS);
        metap.setPokedexHeightM(0.3);
        metap.setHeightStdDev(0.0375);
        metap.setBaseStamina(70);
        ...
        metap.setMovementType(PokemonMeta.MovementType.JUMP);
        metap.setType1(PokemonMeta.PokemonType.FIGHTING);
        ...
        metap.setFamily(PokemonFamilyId.FAMILY_POLIWAG);
        metap.setPokemonClass(PokemonMeta.PokemonClass.RARE);
        metap.setType2(PokemonMeta.PokemonType.FIGHTING);
        metap.setPokedexHeightM(1.3);
        metap.setHeightStdDev(0.1625);
        metap.setBaseStamina(180);
        ...
        metap.setPokedexWeightKg(19.5);
        metap.setMovementType(PokemonMeta.MovementType.PSYCHIC);
        metap.setType1(PokemonMeta.PokemonType.PSYCHIC);
        ...
        metap.setMovementType(PokemonMeta.MovementType.HOVERING);
        metap.setType1(PokemonMeta.PokemonType.GRASS);
        ...
        metap.setPokedexWeightKg(20);
        metap.setMovementType(PokemonMeta.MovementType.HOVERING);
        metap.setType1(PokemonMeta.PokemonType.ROCK);
        ...
        metap.setPokemonClass(PokemonMeta.PokemonClass.VERY_COMMON);
        metap.setType2(PokemonMeta.PokemonType.PSYCHIC);
        metap.setPokedexHeightM(1.2);
        metap.setHeightStdDev(0.15);
        metap.setBaseStamina(180);
        ...
        metap.setPokemonClass(PokemonMeta.PokemonClass.VERY_COMMON);
        metap.setType2(PokemonMeta.PokemonType.STEEL);
        metap.setPokedexHeightM(0.3);
        metap.setHeightStdDev(0.0375);
        metap.setBaseStamina(50);
        ...
        metap.setFamily(PokemonFamilyId.FAMILY_SEEL);
        metap.setPokemonClass(PokemonMeta.PokemonClass.RARE);
        metap.setType2(PokemonMeta.PokemonType.ICE);
        metap.setPokedexHeightM(1.7);
        metap.setHeightStdDev(0.2125);
        metap.setBaseStamina(180);
        ...
        metap.setMovementType(PokemonMeta.MovementType.PSYCHIC);
        metap.setType1(PokemonMeta.PokemonType.GHOST);
        ...
        metap.setPokemonClass(PokemonMeta.PokemonClass.COMMON);
        metap.setType2(PokemonMeta.PokemonType.ROCK);
        metap.setPokedexHeightM(1);
        metap.setHeightStdDev(0.125);
        metap.setBaseStamina(160);
        metap.setCylRadiusM(0.5);
        ...
        metap.setMovementType(PokemonMeta.MovementType.JUMP);
        metap.setType1(PokemonMeta.PokemonType.ICE);
        ...
        metap.setPokemonClass(PokemonMeta.PokemonClass.RARE);
        metap.setType2(PokemonMeta.PokemonType.WATER);
        metap.setPokedexHeightM(0.4);
        metap.setHeightStdDev(0.05);
        metap.setBaseStamina(70);
        ...
        metap.setPokemonClass(PokemonMeta.PokemonClass.LEGENDARY);
        metap.setType2(PokemonMeta.PokemonType.FLYING);
        metap.setPokedexHeightM(1.7);
        metap.setHeightStdDev(0.2125);
        metap.setBaseStamina(180);
        ...
        metap.setMovementType(PokemonMeta.MovementType.JUMP);
        metap.setType1(PokemonMeta.PokemonType.DRAGON);
        ...
        metap.setFamily(PokemonFamilyId.FAMILY_MEWTWO);
        metap.setPokemonClass(PokemonMeta.PokemonClass.MYTHIC);
        metap.setType2(PokemonMeta.PokemonType.NONE);
        metap.setPokedexHeightM(0.4);
        metap.setHeightStdDev(0.05);
